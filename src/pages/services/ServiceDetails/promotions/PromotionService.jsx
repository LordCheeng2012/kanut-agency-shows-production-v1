import { BtnSkyPrimary, Button } from "../../../../components/buttons/Button";
  ...
  return (
    <div className="content-type">
        ...
        <div className="description-promotion">
            ...
            <Button addClass = {`${typeService.color_buttom}`}  title={"SABER MÁS"}></Button>
...
console.log("contexto de servicio cargado : ",serviceDetails.colorClass);
  return (
    <div className="promotion-content-service">
        ...
        <TypeService  typeService={{color_buttom:colorButton}}></TypeService>
        <TypeService  typeService={{color_buttom:colorButton}}></TypeService>
        <TypeService  typeService={{color_buttom:colorButton}}></TypeService>
        </section>
    </div>
